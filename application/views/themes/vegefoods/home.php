...
<section id="home-section" class="hero">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            ...
            <h2 class="subheading mb-4">Kopi Dengan Biji Pilihan</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/jenis-biji-kopi.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            ...
            <h2 class="subheading mb-4">Memberikan Rasa Terbaik </h2>
            <p><a href="#products" class="btn btn-info">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
  ...
  <section class="ftco-section img" style="background-image: url(<?php echo get_theme_uri('images/kopi2.jpg'); ?>);">
  <div class="container">
