...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/josh.jpg'); ?>');">
    <div class="container">
  ...
  <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
          <div class="container">
            ...
            <div class="heading-section-bold mb-4 mt-md-5">
                <div class="ml-md-0">
                  <h2 class="mb-4">Selamat Datang di Kopi Aayam Ras <?php echo get_store_name(); ?></h2>
              </div>
            </div>
            <div class="pb-md-5">
                <p><?php echo get_settings('store_description'); ?></p>
                          <p><a href="<?php echo site_url('#products'); ?>" class="btn btn-info">Belanja sekarang!</a></p>
                      </div>
                  </div>
              </div>
          </div>
